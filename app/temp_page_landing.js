...
define(["jquery","components/content"], function($,content_module) {
    ...
    {
        var instance ={};
        instance['page_left'] = module.dependencies['page_begin'];
        instance['page_right'] = module.dependencies['page_end'];
...
`;
        ...
        instance.render = function()
        {
              ...
              <div class="relative overflow-hidden">
                            ...
                            <div class="bg-white">
                              ...
                              <div class="relative pb-32 bg-gray-800">
                                ...
                                <div class="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
                                  <h1 class="text-4xl font-extrabold tracking-tight text-white md:text-5xl lg:text-6xl">Stream data and transactions</h1>
                                  <p class="mt-6 max-w-3xl text-xl text-gray-300">If you tap your debit card, send bitcoin, open your social media feed, save your game file, or find a unique sword in your game, you might be using a pax infrastructure project. Pax made the systems you depend on every day.</p>
                                </div>
                              </div>
                ...
                <!--  
            style='background-image:url("https://images.unsplash.com/photo-1525130413817-d45c1d127c42?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1920&q=60&&sat=-100"); background-size:cover;'>
